...
import { useEditorBridge, useEditorContent, RichText, Toolbar, DEFAULT_TOOLBAR_ITEMS } from "@10play/tentap-editor";
...
const ShomiTentapEditor = React.forwardRef<ShomiTentapEditorRef, ShomiTentapEditorProps>(
      ...
      theme: {
        ...
        toolbar: {
          toolbarBody: {
            ...
            borderBottomWidth: 1,
            height: 48,
            backgroundColor: isDark ? theme.colors.background : theme.colors.white,
            borderColor: isDark ? theme.colors.greyOutline : theme.colors.greyOutline,
          },
          toolbarButton: {
            backgroundColor: isDark ? theme.colors.background : theme.colors.white,
          },
